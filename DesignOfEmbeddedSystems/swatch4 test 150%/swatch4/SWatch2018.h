...
// @agost code
static enum State { INIT, TIMEDISPLAY, TIMESET, ALARMSET, STOPWATCH,
	ALARMSET_INIT,ALARMSET_SETHOURS, ALARMSET_SETMINUTES, ALARMSET_ALARMFINALLYSET,
	TIMESET_INIT, TIMESET_SETHOURS, TIMESET_SETMINUTES, TIMECOUNT_COUNT,
    ALARMMANAGEMENT_SILENT, ALARMMANAGEMENT_BUZZING,
    TIMECOUNTSTOPWATCH_INIT, TIMECOUNTSTOPWATCH_BEGIN, TIMECOUNTSTOPWATCH_COUNT };
